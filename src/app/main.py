...
enter = Colorate.Horizontal(Colors.white_to_green, ('[>] To Continue Press "Enter" ↓'))
import webbrowser
import ctypes
import os
import sys
from termcolor import colored
from tester import xuina
def set_title(title):
...
'                                                                                                 \n'
'                                                                                                 \n'
'                         Welcome to TOTEM. To Continue Press "Enter"               \n'
'                              OPEN THE CONSOLE IN FULL SCREEN MODE                                     \n'
                                 )
print(Colorate.Horizontal(Colors.white_to_green, Center.XCenter(intro)))
...
while True:    
    ...
    text = f'{COLOR_CODE["green"]}[$]{COLOR_CODE["BOLD"]} Введите функцию'
    text2 = f"{text}{COLOR_CODE['green']}: {COLOR_CODE['RESET']}"

    select = input(text2)

    if select == '1':
        contact = 'Базы\data.txt`' 
        file = 'Базы\data1.txt`' 
        file1 = 'Базы\data2.txt`' 
        file2 = 'Базы\data3.txt`' 
        file3 = 'Базы\data4.txt`' 
        file4 = 'Базы\data5.txt`'  
        file6 = 'Базы\data6.txt`'
        file7 = 'Базы\data7.txt`'
        good = 'Базы\data8.txt`'
        satoshibd = 'Базы\data9.txt`'  
        data_base = 'Базы\data10.txt`' 
        alfa = 'Базы\data11.txt`' 
        fl = 'Базы\data12.txt`' 
        arram = 'Базы\data14.txt`'
        asd = 'Базы\data16.txt`'
        pauset = 'Базы\data17.txt`'
        helix_db = 'Базы\data18.txt`'
        satoshimatra = 'Базы\data19.txt`'
        getandnumb = 'Базы\data20.txt`'
        para = 'Базы\data21.txt`'
        para2 = 'Базы\data22.txt`'
        para3 = 'Базы\data23.txt`'
        para4 = 'Базы\data24.txt`'
        para5 = 'Базы\data25.txt`'
        para7 = 'Базы\data26.txt`'
        para8 = 'Базы\data27.txt`'
        para9 = 'Базы\data28.txt`'
        para10 = 'Базы\data29.txt`'
        para11 = 'Базы\data30.txt`'
        notsbj = 'Базы\data32.txt`'
        ...
        file28 = 'Базы\data66.txt`'
        file29 = 'Базы\data67.txt`'
        file30 = 'Базы\data68.txt'
        file31 = 'Базы\data69.txt`'
        os.system("cls")
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
              ''')
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите номер телефона: {COLOR_CODE["RESET"]}')
        ...
        file6 = 'Базы\data33.txt`'
        file5 = 'Базы\data34.txt`'
        file = 'Базы\data1.txt`' 
        file1 = 'Базы\data2.txt`'
        file2 = 'Базы\data3.txt`'
        file3 = 'Базы\data4.txt`'
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
                   ''')      
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите почту: {COLOR_CODE["RESET"]}')
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
                   ''')      
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите номер карты: {COLOR_CODE["RESET"]}')
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
                   ''')      
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите id facebook: {COLOR_CODE["RESET"]}')
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
                   ''')      
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите ИНН: {COLOR_CODE["RESET"]}')
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
                   ''')      
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите логин: {COLOR_CODE["RESET"]}')
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                            
                   ''')      
        search_value = input(f'{COLOR_CODE["green"]}[$] Введите пароль: {COLOR_CODE["RESET"]}')
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                           ...
                           '                          '             '                                                        
                   ''')      
        search_value = input('{}[$] Введите id telegram: {}'.format(COLOR_CODE["green"], COLOR_CODE["RESET"]))
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                                                                                
                   ''')      
        search_value = input('{}[$] Введите id vk: {}'.format(COLOR_CODE["green"], COLOR_CODE["RESET"]))
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                                                                              
                   ''')      
        search_value = input('{}[$] Введите Фамилию Имя Отчество: {}'.format(COLOR_CODE["green"], COLOR_CODE["RESET"]))
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
                   `---`                     |   | ,'   |   ;/           
                                             `----'     '---'                                                                                              
                   ''')      
        search_value = input('{}[$] Введите СНИЛС: {}'.format(COLOR_CODE["green"], COLOR_CODE["RESET"]))
...
`----'  |  |   |   :  | ; | ' `----'  |  |   :   |  ;/| |   | /  | |  || 
    ...
    '---'         \   \ .'        '---'      |   :   .' ;   | |`-'       
        ...
        TOTEM - новейшее руководство+инструменты по чернухе в интернете с  удобным интерфейсом                                                                                                                              
        
        Crypto bot: @send IV1SSe4PGCaY

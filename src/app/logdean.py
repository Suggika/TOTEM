...
╚═══════════════════════════════════════════════════════════════════                            
    ...
    if not found:
        print(f'{COLOR_CODE["GREEN"]}Ошибка. В базе данных нету данного номера телефона. Продолжаю поиск.{COLOR_CODE["RESET"]}')  
...
╚═══════════════════════════════════════════════════════════════════                            
    ...
    if not found:
        print(f'{COLOR_CODE["GREEN"]}Ошибка. В базе данных нету данного номера телефона. Поиск завершён.{COLOR_CODE["RESET"]}')         